    ...
    for (height = 0; height < SCREEN_SIZE; height++) {
        for (width = 0; width < SCREEN_SIZE; width++) {
         ...
         //   coord = coord * 2.0f - 1.0f; // 0 -> 1 to -1 -> 1
           ...
           //     screen[((height + width * SCREEN_SIZE) * 4)] = 255;
           //     screen[((height + width * SCREEN_SIZE) * 4)+1] = 255;
           //     screen[((height + width * SCREEN_SIZE) * 4)+2] = 255;
           //     screen[((height + width * SCREEN_SIZE) * 4)+3] = 255;
           // }
           // else {
           //     screen[((height + width * SCREEN_SIZE) * 4)] = 0;
             //   screen[((height + width * SCREEN_SIZE) * 4)+1] = 0;
             //   screen[((height + width * SCREEN_SIZE) * 4)+2] = 0;
             //   screen[((height + width * SCREEN_SIZE) * 4)+3] = 0;
            screen[(height +width*SCREEN_SIZE)*4] = PerPixel(coord);
            }
        }
...
//    return 0;
//}
unsigned char Scene::PerPixel(glm::vec2 coord)
{
